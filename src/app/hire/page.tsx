        ...
        <div className="section-container grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
          <div className="space-y-6">
            ...
            <div className="surface p-6">
              <p className="text-sm font-bold uppercase tracking-[0.18em] text-ink-faint">What helps us match well</p>
              <ul className="mt-4 space-y-3 text-ink-muted">
                <li>&bull; The tasks the VA will actually own</li>
                <li>&bull; Weekly hours and preferred overlap</li>
                <li>&bull; Tools or systems they will use</li>
                <li>&bull; Timeline for start and onboarding</li>
              </ul>
            </div>
          </div>
        ...
        <div className="section-container grid gap-6 lg:grid-cols-2">
          ...
          <div className="surface p-7">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <Link href="/pricing" className="btn btn-primary">Review pricing model</Link>
              <Link href="/how-it-works" className="btn btn-secondary">See the process</Link>
            </div>
          </div>
        </div>
      </section>
